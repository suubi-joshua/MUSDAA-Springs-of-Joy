...
- Name: happy-paths.spec.ts >> Happy Path - User Journeys >> Scenario 2: Customization (Type-Scale) >> User closes type-scale control
- Location: e2e/happy-paths.spec.ts:101:9
