...
- Name: happy-paths.spec.ts >> Happy Path - User Journeys >> Scenario 2: Customization (Type-Scale) >> User decreases font size -> Text becomes smaller
- Location: e2e/happy-paths.spec.ts:77:9
