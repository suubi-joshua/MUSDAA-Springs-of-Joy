...
- Name: happy-paths.spec.ts >> Happy Path - User Journeys >> Scenario 1: Discovery >> User navigates back from hymn detail
- Location: e2e/happy-paths.spec.ts:38:9
