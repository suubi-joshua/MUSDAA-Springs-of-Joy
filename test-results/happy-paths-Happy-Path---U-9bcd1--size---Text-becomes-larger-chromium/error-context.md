...
- Name: happy-paths.spec.ts >> Happy Path - User Journeys >> Scenario 2: Customization (Type-Scale) >> User increases font size -> Text becomes larger
- Location: e2e/happy-paths.spec.ts:53:9
