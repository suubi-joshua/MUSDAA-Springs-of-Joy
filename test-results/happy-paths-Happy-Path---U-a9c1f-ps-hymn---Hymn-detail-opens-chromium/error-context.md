...
- Name: happy-paths.spec.ts >> Happy Path - User Journeys >> Scenario 1: Discovery >> User opens app -> Sees hymn list -> Taps hymn -> Hymn detail opens
- Location: e2e/happy-paths.spec.ts:27:9
