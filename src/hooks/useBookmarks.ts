...
import { addBookmark, removeBookmark, getBookmarkedHymns } from '../db/database'
...
export function useBookmarks() {
  ...
  const isBookmarked = useCallback((hymnId: number) => bookmarkedIds.has(hymnId), [bookmarkedIds])
